...
<body id="page-top">
<?php
require('./assets/mail/config.php');
session_start();
            ...
            <div class="row align-items-stretch mb-5">
                <div class="col-md-6">
                    <div class="form-group">
                        <input class="form-control" id="username" type="text" placeholder="Votre identifiant" required="required" data-validation-required-message="Entrez votre identifiant." />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="form-group">
                        <input class="form-control" id="pwd" type="email" placeholder="Votre mot de passe" required="required" data-validation-required-message="Entrez votre mot de passe." />
                        <p class="help-block text-danger"></p>
                    </div>
            </div>
            <div class="text-center">
